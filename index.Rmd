---
title: "Jose Luis Manzanares Rivera"
---
```{r,echo = FALSE,out.width = "100px"}

knitr::include_graphics("https://res.cloudinary.com/jlmrpics/image/upload/v1558121560/aavatar_jz1beq.jpg")
```
...
***
### Proyecto: Social Determinants of Health in México. (SDHmx)

La investigación  en esta línea busca situar las expresiones de salud en su contexto social.  Especialmente se analizan los procesos de salud enfermedad desde una perspectiva multidisciplinaria, considerando el impacto regional de los grandes problemas nacionales en materia de salud pública. 
Esta línea de investigación ha resultado en publicaciones en revistas especializadas líderes en el campo  posicionando el trabajo del El Colef en países como  Argentina, Colombia, Costa Rica y Estados Unidos.

Adicionalmente se han generado investigaciones pioneras en México en respuesta a convocatorias internacionales de instituciones como la Organización Panamericana de salud (PAHO) ante emergencias de  salud pública internacional como el caso del brote del virus Zika. E investigaciones recientes que contrastan la evolución en las fronteras de México de epidemias por padecimientos crónicos degenerativos como la Diabetes tipo II que por su magnitud se consideran de alto impacto para el bienestar de la población en México y un riesgo financiero para el sistema de salud.

### Resultados de investigación. 

Manzanares Rivera, José Luis,  2019, [Síndrome de dificultad respiratoria del recién nacido en México: Oportunidades para el diseño de estrategias de prevención.](https://revistas.javeriana.edu.co/index.php/gerepolsal/index) *Forthcoming*, núm. 36, enero-junio, *Revista Gerencia y Políticas de Salud*. Colombia.
...
### Proyecto: Economía Ambiental (PEA).
***

Es un esfuezo de investigación que incorpora herramientas de análisis como imagenes obtenidas mediante percepción remota principalmente del proyecto Landsat7 y 8 Thematic mapper y se orienta al estudio de fenómenos ambientales. Como área complementaria de exploración en este proyecto se desarrolla investigación sobre el uso de los recursos hídricos  en el conexto de México.
